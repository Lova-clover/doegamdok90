...
| Package | Purpose | License |
| --- | --- | --- |
| Remotion / `@remotion/cli` / `@remotion/transitions` 4.x | Programmatic video composition, transitions, and rendering | Remotion License |
| edge-tts 7.2.8 | Build-time Korean neural narration generation | LGPL-3.0 |
| React / React DOM 19.2.0 | Video component runtime | MIT |
| @phosphor-icons/react 2.1.x | Video cursor icon | MIT |
