...
SLIDES = ROOT / "output" / "presentation" / "touchline-replay-90-presentation-v6"
OUTPUT = ROOT / "output" / "pdf" / "touchline-replay-90-winning-proposal-v6.pdf"
PAGE_SIZE = (960, 540)
...
def main() -> None:
    ...
    document.setTitle("Touchline Replay 90 - Winning Proposal V6")
